...
public class OracleSQLDAO {
    private List<Article> getArticles(String query) throws SQLException  {
    ...
    public List<Article> getArticlesByFields(List<ArticleFieldValue> ArticleRequests) throws SQLException {
    ...
    public boolean modifyArticle(int id, List<ArticleFieldValue> newValues) throws SQLException {
        if (newValues.size() == 0) {
            return false;
        }
